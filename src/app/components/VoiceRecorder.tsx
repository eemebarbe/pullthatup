    ...
    const processBatches = async () => {
      ...
      try {
        ...
        const validResults = results.filter((result, index) => {
          return result !== null && !processedText.has(pendingBatches[index]);
        });
  ...
  return (
    <div className={styles.container}>
      <div className={styles.headerRow}>
        ...
        <Recorder onTranscript={onTranscript} setIsRecording={setIsRecording} />
      </div>
                ...
                <div className={styles.cell}>
                  <div className={styles.currentTranscript}>
                    ...
                    <div className={styles.wordCount}>
                      <div className={styles.recordingIndicator} />
                      Words: {
                        currentTranscript.trim().split(/\s+/).length
                      } / {WORD_BATCH_SIZE}
                    </div>
                  </div>
                </div>
